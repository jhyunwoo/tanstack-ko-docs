...
- [persistQueryClient](../../react/plugins/persistQueryClient.md#persistqueryclientprovider) 구성 요소를 사용하여 앱을 래핑합니다.
...
재시도는 비동기식일 수도 있다는 점을 제외하면 [createSyncStoragePersister](../../react/plugins/createSyncStoragePersister.md)와 동일하게 작동합니다. 미리 정의된 모든 재시도 처리기를 사용할 수도 있습니다.
