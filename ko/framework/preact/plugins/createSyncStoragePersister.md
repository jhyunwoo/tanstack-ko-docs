...
대신 [createAsyncStoragePersister](../../react/plugins/createAsyncStoragePersister.md)를 사용할 수 있습니다.
...
- [persistQueryClient](../../react/plugins/persistQueryClient.md) 함수에 전달하세요.
...
기본적으로 재시도는 발생하지 않습니다. 사전 정의된 전략 중 하나를 사용하여 재시도를 처리할 수 있습니다. `from '@tanstack/preact-query-persist-client'`를 가져올 수 있습니다.
