...
대규모 애플리케이션에서 Query 키를 구성하는 방법에 대한 팁은 [Effective Preact Query Keys](https://tkdodo.eu/blog/ Effective-preact-query-keys)를 살펴보고 [Query Key Factory를 확인하세요. 패키지](https://github.com/lukemorales/query-key-factory)
