...
TanStack Query(이전의 Preact Query)는 종종 웹 애플리케이션용 누락된 데이터 가져오기 라이브러리로 설명되지만 좀 더 기술적인 용어로 말하면 웹 애플리케이션에서 **서버 상태 가져오기, 캐싱, 동기화 및 업데이트**를 매우 쉽게 만듭니다.
...
- 놀랍도록 철저한 [연습 가이드](../react/installation.md) 및 [useQuery](../react/reference/useQuery.md)를 통해 자신의 속도에 맞춰 TanStack Query를 알아보세요.
- 기사 [Preact Query를 원하는 이유](https://tkdodo.eu/blog/why-you-want-preact-query)를 참조하세요.
