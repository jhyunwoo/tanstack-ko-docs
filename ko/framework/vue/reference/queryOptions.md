...
일반적으로 [useQuery](../../react/reference/useQuery.md)에도 전달할 수 있는 모든 것을 `queryOptions`에 전달할 수 있습니다. 일부 옵션은 `queryClient.prefetchQuery`와 같은 함수로 전달될 때 아무런 효과가 없지만 TypeScript는 이러한 초과 속성에도 여전히 문제가 없습니다.
