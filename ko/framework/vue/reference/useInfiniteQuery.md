...
`useInfiniteQuery`에 대한 옵션은 다음을 추가하면 [useQuery](../../react/reference/useQuery.md)와 동일합니다.

- `queryFn: (context: QueryFunctionContext) => Promise<TData>`
  - **필수이지만 기본 query 함수가 정의되지 않은 경우에만** [`defaultQueryFn`](../../react/guides/default-query-function.md)
...
`useInfiniteQuery`에 대해 반환된 속성은 [useQuery](../../react/reference/useQuery.md)와 동일하지만 다음 속성이 추가되고 `isRefetching` 및 `isRefetchError`에 약간의 차이가 있습니다.
